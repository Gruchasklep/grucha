...
<body data-spy="scroll" data-target=".navbar-collapse">
						...
						<div class="col-md-6">
							<div class="about_accordion wow fadeIn">
								<div id="faq_main_content" class="faq_main_content">
									...
									<h6> <i class="fa fa-angle-right"></i> PLAN DIETETYCZNY </h6>
									<div>
										<div class="content">
					...
					<div class="about_bottom_content">
						...
						<div class="col-md-4">
							<div class="about_bottom_item m-top-20">
								<div class="ab_head">
									<div class="ab_head_icon">
										<img src="assets/images/ikona2.png" class="logo logo-display m-top-10" alt="">
									</div>
				...
				<div class="row">
					<div class="main_blog text-center roomy-100">
						<div class="col-sm-8 mr-sm-auto ml-sm-auto">
							...
							<a href="blog.html" target="_blank" class="btn btn-success m-">ZOBACZ BLOGA!</a>
						</div>
							</div>
						</div>
								...
								<div class="blog_item m-top-20">
									...
									<div class="blog_text roomy-40">
										<h6>JAK NUCZYĆ SIĘ STAĆ NA RĘKACH?</h6>
												<p><em><a class= "text-success" href="blog.html"><b><u>Zobacz artykuł!</u></b></a> /<a >autor: Damian Gruszczyński</a><a > </a></em></p>
									</div>
								</div>
							</div>
							<div class="col-md-4">
		...
		<footer id="footer" class="footer bg-black">
			<div class="container">
				<div class="row">
					...
					<div class="main_footer text-center p-top-40 p-bottom-30 left-10">
					<a href="polityka-prywatności.html" class="text-white m-bottom-20"><u>Polityka Prywatności</u>.</a>
					<a class="text-white left-10"> | Twórca: Damian Gruszczyński.
					<a class="text-white"> | Copyright © 2020 TrenerGrucha.
 ...
 <div class="cookie-container">
      <p>
        Informacja: Serwis niniejszy wykorzystuje do prawidłowego działania pliki cookies.
        <a href="polityka-prywatności.html">[Wyświetl więcej]</a>
      </p>
